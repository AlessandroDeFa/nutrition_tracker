...
class ProfileFormState extends Equatable {
  ...
  const ProfileFormState({required this.type, required this.activity, required this.name, required this.weight,required this.height, required this.age, });
  ...
  bool get validProfileForm => validHeight && validWeight && validType && validAge && validActivity;
